...
<div class="chords-diagram">
    ...
    <div class="chord-image-wrap">
        <div id="chord-image" data-chord="<?= Yii::t('app', 'Chord') ?>">
            <img src="<?= $model->getImageUrl() ?>" alt="<?= $imageTitle ?>" title="<?= $imageTitle ?>">
        </div>
        <div id="chord-link-wrap">
            ...
            <div class="ui action input">
                <input type="text" class="form-control chord-image-url" value="<?= $model->getImageUrl() ?>"
                       data-placement="right"
                       data-toggle="popover"
                       data-content="<?= Yii::t('app', 'Copied') ?>">
            </div>
            <div class="chord-buttons-wrap">
                <button class="copy-chord-url btn btn-chord">
                    <?= Yii::t('app', 'Copy URL'); ?>
                </button>
                <a href="<?= $model->getImageUrl() ?>" download="<?= $chordName ?>.png"
                   class="btn btn-chord download-image">
                    <?= Yii::t('app', 'Download') ?>
